...
ActiveRecord::Schema.define(version: 2019_01_20_051544) do
  ...
  create_table "periods", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.bigint "editorials_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["editorials_id"], name: "index_periods_on_editorials_id"
  end
  ...
  add_foreign_key "periods", "editorials", column: "editorials_id"
end
